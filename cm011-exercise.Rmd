...
a[1:n]<-1:2
a
(a[1:n]<-1:2) #outer() dont execute the code here
a[1:n]<-1:3
a
```
...
```{r}
(my_list <- list(year=2018, instructor=c("Vincenzo", "Coia"), fav_fun=typeof)) #can store anything in the components of a list
```
